 ...
 return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex flex-col xl:flex-row items-start xl:items-center w-full shrink-0 gap-6 mb-[24px]">
        ...
        <label className="border border-dashed border-aura-cyan/50 bg-aura-cyan/5 hover:bg-aura-cyan/10 text-aura-cyan p-3 flex items-center justify-center cursor-pointer transition-colors gap-2 w-full">
          <UploadCloud size={16} />
        ...
        <div className="w-full xl:col-span-4 flex flex-col gap-[26px] overflow-y-auto pr-1 min-h-0">
          ...
          <div className="flex flex-col border-2 border-aura-dark bg-aura-inner shrink-0 transition-all">
            <button 
              ...
              className="flex justify-between items-center w-full p-[18px] hover:bg-aura-dark/20 transition-colors"
            >
              ...
              <div className="flex flex-col gap-[18px] p-[18px] pt-0 border-t border-aura-dark/50">
                ...
                <div className="flex flex-col gap-[14px]">
                    {catalog.filter(i => i.type === catalogTab).map(item => (
                      <div 
                        key={item.id} onClick={() => updateSlot({ boundItemId: item.id })}
                        className={`flex items-center gap-[14px] p-[9px] border cursor-pointer transition-colors ${activeSlot?.boundItemId === item.id ? (item.type === 'menu' ? 'border-aura-cyan bg-aura-cyan/10' : 'border-purple-500 bg-purple-500/10') : 'border-aura-dark hover:border-aura-green/50 bg-aura-bg hover:bg-aura-panel'}`}
                      >
          ...
          <div className="flex flex-col border-2 border-aura-cyan/30 bg-aura-inner/80 shadow-[0_0_20px_rgba(0,229,255,0.05)] shrink-0 transition-all mb-[20px]">
            <button 
              ...
              className="flex justify-between items-center w-full p-[18px] hover:bg-aura-cyan/10 transition-colors"
            >
            ...
            {isPropertiesOpen && (
              <div className="flex flex-col gap-[14px] p-[18px] pt-0 border-t border-aura-cyan/30">
                ...
                <div className="flex flex-col gap-[9px] mt-[9px]">
                   ...
                   <select 
                      value={activeSlot?.fontFamily || 'font-mono'}
                ...
                <div className="flex flex-col gap-[9px] mt-[9px]">
                  ...
                  <div className="flex gap-[9px]">
                      {['#00e5ff', 'var(--color-aura-green)', '#ff003c', '#ffffff', '#a855f7'].map(c => (
                        <button 
                          key={c} type="button" onClick={() => updateSlot({ neonColor: c })}
                  ...
                  <div className="flex gap-[18px]">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <input 
                        ...
                        value={activeSlot?.posY || 0} 
                        onChange={e => updateSlot({posY: parseInt(e.target.value)})} 
                        className="h-28 accent-pink-500 cursor-ns-resize"
                ...
                <div className="flex flex-col gap-[9px] mt-[14px]">
                  <label className="text-[12px] uppercase opacity-60">Etiqueta Promocional (Sticker)</label>
                  <select 
